...
class Auth {
  ...
  async check(success) {
    ...
    if (!response.ok) {
      ...
      localStorage.removeItem('accessToken'); //     Toast.show("session expired, please sign in")
      // redirect to sign in      
      //     gotoRoute('/signin')
...
class HomeView {
  ...
  quizHandler(e) {
    ...
    dialogEL.className = 'quiz-dialog'; //- sl-dialog content 
    ...
    dialogEL.show(); //- on hide delete sl-dialog
...
class GuideView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <td-app-header title=\"Guide\" user=\"", "\"></td-app-header>\n      <div class=\"page-content calign\">        \n        \n        Some intro information\n\n        <sl-button type=\"primary\" @click=", ">Okay got it!</sl-button>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/favouritePackages.js":[function(require,module,exports) {
"use strict";
...
class favouritePackagesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <td-app-header title=\"Favourite Packages\" user=\"", "\"></td-app-header>\n      <div class=\"page-content\">        \n        <h1>Favourite Packages</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new favouritePackagesView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"PackageAPI.js":[function(require,module,exports) {
"use strict";
...
class PackageAPI {
  ...
  async newPackage(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/package"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
...
var _default = new PackageAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/packages.js":[function(require,module,exports) {
"use strict";
...
var _default = new packagesView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../PackageAPI":"PackageAPI.js"}],"views/pages/newPackage.js":[function(require,module,exports) {
"use strict";
...
class newPackageView {
  ...
  async newPackageSubmitHandler(e) {
    ...
    try {
      await _PackageAPI.default.newPackage(formData);

      _Toast.default.show('Package added!');

      submitBtn.removeAttribute('loading'); // reset form
      // reset text - text inputs

      const textInputs = document.querySelectorAll('sl-input, sl-textarea');
      if (textInputs) textInputs.forEach(textInput => textInput.value = null); // reset radial inputs

      const radioInputs = document.querySelectorAll('sl-radio');
      if (radioInputs) radioInputs.forEach(radioInput => radioInput.removeAttribute('checked')); // reset image
...
var _default = new newPackageView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../PackageAPI":"PackageAPI.js","../../Toast":"Toast.js"}],"views/pages/userDashboard.js":[function(require,module,exports) {
"use strict";
...
var _default = new OurStoryView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/faqs.js":[function(require,module,exports) {
"use strict";
...
var _default = new FaqsView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Utils":"Utils.js","./../../Auth":"Auth.js"}],"views/pages/testimonies.js":[function(require,module,exports) {
"use strict";
...
class TestimoniesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n     <td-app-header title=\"What They Say\" user=", "></td-app-header>\n      <div class=\"page-content\">\n      \n       \n        <h3>Page content for testimonies</h3>\n        Static examples to start with.\n        \n        <td-site-footer></td-site-footer>\n      </div>\n      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new TestimoniesView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Utils":"Utils.js","./../../Auth":"Auth.js"}],"views/pages/travelTips.js":[function(require,module,exports) {
"use strict";
...
class TravelTipsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n     <td-app-header title=\"Travel Tips\" user=", "></td-app-header>\n      <div class=\"page-content\">\n      \n       \n        <h3>Travel tips content here</h3>\n        \n        <td-site-footer></td-site-footer>\n      </div>\n      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new TravelTipsView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Utils":"Utils.js","./../../Auth":"Auth.js"}],"views/pages/findus.js":[function(require,module,exports) {
"use strict";
...
var _default = new FindusView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Utils":"Utils.js","../../Auth":"Auth.js"}],"views/pages/admin.js":[function(require,module,exports) {
"use strict";
...
var _favouritePackages = _interopRequireDefault(require("./views/pages/favouritePackages"));

var _packages = _interopRequireDefault(require("./views/pages/packages"));

var _newPackage = _interopRequireDefault(require("./views/pages/newPackage"));

var _userDashboard = _interopRequireDefault(require("./views/pages/userDashboard"));

var _ourStory = _interopRequireDefault(require("./views/pages/ourStory"));

var _faqs = _interopRequireDefault(require("./views/pages/faqs"));

var _testimonies = _interopRequireDefault(require("./views/pages/testimonies"));

var _travelTips = _interopRequireDefault(require("./views/pages/travelTips"));

var _findus = _interopRequireDefault(require("./views/pages/findus"));

var _admin = _interopRequireDefault(require("./views/pages/admin"));
...
const routes = {
  ...
  '/favouritePackages': _favouritePackages.default,
  '/packages': _packages.default,
  '/newPackage': _newPackage.default,
  '/userDashboard': _userDashboard.default,
  '/ourStory': _ourStory.default,
  '/faqs': _faqs.default,
  '/testimonies': _testimonies.default,
  '/travelTips': _travelTips.default,
  '/findus': _findus.default,
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/favouritePackages":"views/pages/favouritePackages.js","./views/pages/packages":"views/pages/packages.js","./views/pages/newPackage":"views/pages/newPackage.js","./views/pages/userDashboard":"views/pages/userDashboard.js","./views/pages/ourStory":"views/pages/ourStory.js","./views/pages/faqs":"views/pages/faqs.js","./views/pages/testimonies":"views/pages/testimonies.js","./views/pages/travelTips":"views/pages/travelTips.js","./views/pages/findus":"views/pages/findus.js","./views/pages/admin":"views/pages/admin.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('td-app-header', class AppHeader extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  render() {
    return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>      \n      * {\n        box-sizing: border-box;\n      }\n      .app-header {\n            /*adds blur*/\n        backdrop-filter: blur(8px);\n        background-color:rgba(255, 255, 255, 0.185);\n        position: fixed;\n        top: 0;\n        right: 0;\n        left: 0;\n        height: var(--app-header-height);\n        color: #000;\n        display: flex;\n        z-index: 9;\n        box-shadow: 4px 0px 10px rgba(0,0,0,0.2);\n        align-items: center;\n        box-shadow: rgba(0, 0, 0, 0.05) 0px 1px 2px 0px;\n      }\n\n\n      \n\n      .app-header-main {\n        flex-grow: 1;\n        display: flex;\n        align-items: center;\n      }\n\n      .app-header-main::slotted(h1){\n        color: #000;\n      }\n\n      .app-logo a {\n        color: #fff;\n        text-decoration: none;\n        font-weight: bold;\n        font-size: 1.2em;\n        padding: .6em;\n        display: inline-block;        \n      }\n\n      .app-logo img {\n        width: 90px;\n      }\n      \n      .hamburger-btn::part(base) {\n        color: #fff;\n      }\n\n      .app-top-nav {\n        display: flex;\n        height: 100%;\n        align-items: center;\n      }\n\n      .app-top-nav a {\n        display: inline-block;\n        padding: .8em 2em;\n        text-decoration: none;\n        color: #000;\n      }\n      \n      .app-side-menu-items a {\n        display: block;\n        padding: .5em;\n        text-decoration: none;\n        font-size: 1.3em;\n        color: #333;\n      }\n\n      .app-side-menu-logo {\n\n        margin-bottom: 1em;\n        position: absolute;\n        top: 2em;\n        left: 1.5em;\n      }\n\n      .page-title {\n        color: var(--app-header-txt-color);\n        margin-right: 0.5em;\n        font-size: var(--app-header-title-font-size);\n      }\n\n      .hamburger-btn::part(base) {\n        color: #000;\n        padding: 0 1em 0 1.5em;\n      }\n\n      sl-button {\n        padding: 0 20px;\n      }\n\n      .hi-user {\n        font-size: 1.5em;\n      }\n\n      /* active nav links */\n      .app-top-nav a.active,\n      .app-side-menu-items a.active {\n        font-weight: bold;\n      }\n\n      /* RESPONSIVE - MOBILE ------------------- */\n      @media all and (max-width: 768px){       \n        \n        .app-top-nav {\n          display: none;\n        }\n      }\n\n    </style>\n\n    <header class=\"app-header\">\n      <sl-icon-button class=\"hamburger-btn\" name=\"list\" @click=\"", "\" style=\"font-size: 3em;\"></sl-icon-button>       \n      \n      <div class=\"app-header-main\">\n        <a href=\"/\" @click=\"", "\">\n          <img src = \"images/topdeck-black.png\" alt = \"top deck logo in black\" height=\"50px\">\n        </a>\n      </div>\n\n      <nav class=\"app-top-nav\">\n\n        ", "\n      </nav>\n    </header>\n\n    <sl-drawer class=\"app-side-menu\" placement=\"left\">\n      <nav class=\"app-side-menu-items\">\n      <a href=\"/\" @click=\"", "\">\n          <img class=\"app-side-menu-logo\" src = \"images/topdeck-black.png\" alt = \"top deck logo in black\" height=\"70px\">\n        </a>\n        <a href=\"/\" @click=\"", "\">Home</a>\n        ", "\n\n        ", "\n\n        <a href=\"/packages\" @click=\"", "\">Find a Tour</a>\n        <a href=\"/travelTips\" @click=\"", "\">Travel Tips</a>\n        <a href=\"/faqs\" @click=\"", "\">FAQs</a>\n        <a href=\"/testimonies\" @click=\"", "\">Testimonies</a>\n        <a href=\"/ourStory\" @click=\"", "\">Our Story</a>\n        <a href=\"/findus\" @click=\"", "\">Find Us</a>\n      </nav>  \n    </sl-drawer>\n    "])), this.hamburgerClick, this.logoClick, localStorage.accessToken == null ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <sl-button class=\"anim-in\" @click=", ">Sign In</sl-button>\n        "])), () => (0, _Router.gotoRoute)('/signin')) : (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n\n            ", "\n            <p class=\"hi-user\">Hi ", "!</p>\n\n            <sl-dropdown>\n              \n              <a slot=\"trigger\" href=\"#\" @click=\"", "\">\n              \n              <sl-avatar style=\"--size: 50px;\" image=", "></sl-avatar> \n                \n              </a>\n              <sl-menu>            \n                <sl-menu-item @click=\"", "\">Me & My Trips</sl-menu-item>\n                <sl-menu-item @click=\"", "\">Edit Profile</sl-menu-item>\n                <sl-menu-item @click=\"", "\">Sign Out</sl-menu-item>\n              </sl-menu>\n            </sl-dropdown>\n        "])), this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n              <a href=\"/newPackage\" @click=\"", "\">Add Package</a>  \n            "])), _Router.anchorRoute) : (0, _litElement.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([""]))), this.user && this.user.firstName, e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', () => (0, _Router.gotoRoute)('/userDashboard'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut()), this.logoClick, this.menuClick, this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n          <a href=\"/newPackage\" @click=\"", "\">Add Package</a> \n          <a href=\"/admin\" @click=\"", "\">Admin</a>  \n        "])), this.menuClick, this.menuClick) : (0, _litElement.html)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral([""]))), localStorage.accessToken == null ? (0, _litElement.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n          <a href=\"/signin\" @click=\"", "\">Sign in to Dashboard</a>\n        "])), this.menuClick) : (0, _litElement.html)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n          <a href=\"/userDashboard\" @click=\"", "\">My & My Trips</a>\n        "])), this.menuClick), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick);
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js"}],"components/td-packages.js":[function(require,module,exports) {
"use strict";
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js"}],"components/td-site-footer.js":[function(require,module,exports) {
"use strict";
...
customElements.define('td-site-footer', class SiteFooter extends _litElement.LitElement {
  constructor() {
    super();
  }
...
},{"./..\\..\\static\\images\\FYT-Hero.jpg":[["FYT-Hero.e873a6a8.jpg","../static/images/FYT-Hero.jpg"],"../static/images/FYT-Hero.jpg"],"./..\\..\\static\\images\\HOME-Popular-Bali.jpg":[["HOME-Popular-Bali.1538d806.jpg","../static/images/HOME-Popular-Bali.jpg"],"../static/images/HOME-Popular-Bali.jpg"],"./..\\..\\static\\images\\HOME-Popular-Med.jpg":[["HOME-Popular-Med.5e94e1bc.jpg","../static/images/HOME-Popular-Med.jpg"],"../static/images/HOME-Popular-Med.jpg"],"./..\\..\\static\\images\\FYT-AmericanNights.jpg":[["FYT-AmericanNights.e88c73d1.jpg","../static/images/FYT-AmericanNights.jpg"],"../static/images/FYT-AmericanNights.jpg"],"./..\\..\\static\\images\\FYT-AztecImmersion.jpg":[["FYT-AztecImmersion.a560441e.jpg","../static/images/FYT-AztecImmersion.jpg"],"../static/images/FYT-AztecImmersion.jpg"],"./..\\..\\static\\images\\HOME-1.jpg":[["HOME-1.14760647.jpg","../static/images/HOME-1.jpg"],"../static/images/HOME-1.jpg"],"./..\\..\\static\\images\\Home-Man-By-Train.jpg":[["Home-Man-By-Train.e235c88a.jpg","../static/images/Home-Man-By-Train.jpg"],"../static/images/Home-Man-By-Train.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"./App.js":"App.js","./components/td-app-header":"components/td-app-header.js","./components/td-packages":"components/td-packages.js","./components/td-site-footer":"components/td-site-footer.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
