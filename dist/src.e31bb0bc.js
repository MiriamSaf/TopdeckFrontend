...
class HomeView {
  ...
  yesOneHandler(e) {
    ...
    const answerOne = document.getElementById('a1'); // add class name

    questionOne.classList.add('hidden'); // remove class name = removeClass()
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Utils":"Utils.js","../../Auth":"Auth.js"}],"views/pages/getPackageTest.js":[function(require,module,exports) {
"use strict";
...
var _getPackageTest = _interopRequireDefault(require("./views/pages/getPackageTest"));
...
const routes = {
  ...
  '/getPackageTest': _getPackageTest.default
};
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/favouritePackages":"views/pages/favouritePackages.js","./views/pages/packages":"views/pages/packages.js","./views/pages/newPackage":"views/pages/newPackage.js","./views/pages/userDashboard":"views/pages/userDashboard.js","./views/pages/ourStory":"views/pages/ourStory.js","./views/pages/faqs":"views/pages/faqs.js","./views/pages/testimonies":"views/pages/testimonies.js","./views/pages/travelTips":"views/pages/travelTips.js","./views/pages/findus":"views/pages/findus.js","./views/pages/admin":"views/pages/admin.js","./views/pages/getPackageTest":"views/pages/getPackageTest.js"}],"App.js":[function(require,module,exports) {
"use strict";
